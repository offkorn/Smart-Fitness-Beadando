...
-- Adatok beszúrása a WORKOUT_PLANS táblába
...
-- Adatok beszúrása a WORKOUT_DAYS táblába
...
-- Adatok beszúrása a WORKOUT_EXERCISES táblába
...
-- Adatok beszúrása a WORKOUT_STATUS táblába
...
-- Adatok beszúrása a USERS_LEVEL_GOAL táblába
INSERT INTO USERS_LEVEL_GOAL (FITNESS_LEVEL, GOAL, WEEKLY_WORKOUTS)
VALUES
('Beginner', 'Lose Fat', 3);

INSERT INTO USERS_LEVEL_GOAL (FITNESS_LEVEL, GOAL, WEEKLY_WORKOUTS)
VALUES
('Intermediate', 'Gain Muscle', 5);

INSERT INTO USERS_LEVEL_GOAL (FITNESS_LEVEL, GOAL, WEEKLY_WORKOUTS)
VALUES
('Advanced', 'Maintain Fitness', 6);
